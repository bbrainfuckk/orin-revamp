...
assert.ok(responses[1].result.tools.some((tool) => tool.name === 'orin_list_logs'));
assert.ok(responses[1].result.tools.some((tool) => tool.name === 'orin_describe_control_plane'));
assert.ok(responses[1].result.tools.some((tool) => tool.name === 'orin_get_resource'));
assert.ok(responses[1].result.tools.some((tool) => tool.name === 'orin_plan_changes'));
assert.ok(responses[1].result.tools.some((tool) => tool.name === 'orin_apply_changes'));
