...
const InboxPage = lazy(() => loadPages().then((module) => ({ default: module.InboxPage })));
const ContactsPage = lazy(() => loadPages().then((module) => ({ default: module.ContactsPage })));
const AutomationsPage = lazy(() => loadPages().then((module) => ({ default: module.AutomationsPage })));
